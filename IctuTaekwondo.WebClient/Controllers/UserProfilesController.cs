...
namespace IctuTaekwondo.WebClient.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Gender,DateOfBirth,Address,CurrentRank,JoinDate,UserId")] UserProfile userProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Gender,DateOfBirth,Address,CurrentRank,JoinDate,UserId")] UserProfile userProfile)
        {

...
namespace IctuTaekwondo.Shared.Services.Users
{
    public interface IUsersService
    {
        ...
        public Task<bool> SetPasswordAsync(string token, string id, AdminSetPasswordSchema schema);
        public Task<bool> UpdateRolesAsync(string token, string id, UpdateRolesSchema schema);
    }
}
